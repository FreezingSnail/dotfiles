...
local highlights = {
  ...
  SnacksPickerList = { fg = c.fg, bg = "NONE" },
  SnacksPickerBox = { fg = c.fg, bg = "NONE" },
  SnacksPickerBorder = { fg = c.border, bg = "NONE" },
  SnacksPickerListBorder = { fg = c.border, bg = "NONE" },
  SnacksPickerBoxBorder = { fg = c.border, bg = "NONE" },
  SnacksPickerTitle = { fg = c.aqua, bg = "NONE", bold = true },
